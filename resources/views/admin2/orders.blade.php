          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y"> 
              ...
              <div class="d-flex justify-content-end mb-4">
                <a href="{{url('/addneworder')}}"><button type="button" class="btn btn-outline-primary">Add New Order</button></a>
              </div>
                              ...
                              <ul>
                                  @if(isset($orderItems[$order->id]))
                                      @foreach($orderItems[$order->id] as $item)
                                          <li>{{ $item->foodname }} (RM {{ number_format($item->price, 2) }} x {{ $item->quantity }})</li>
                                      @endforeach
                                  @else
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{url('/updateorder', $order->id)}}"
                                  ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                >
                                <a class="dropdown-item" href="{{url('/deleteorder', $order->id)}}"
