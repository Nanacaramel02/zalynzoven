        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Catalogue /</span> Add New Product</h4>
                        ...
                        <div class="card-body">
                            <form action="{{url('/uploadfood')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"placeholder="Write a product's name" required/>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">Price</label>
                                    <input type="num" class="form-control" id="price" name="price" placeholder="Enter the price" required/>
                                </div>
                                <div class="mb-3">
