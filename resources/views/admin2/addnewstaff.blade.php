        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Staff /</span> Add New Staff</h4>
                        ...
                        <div class="card-body">
                            <form action="{{url('/uploadstaff')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="staffName" name="staffName" placeholder="Write a Staff's name" required/>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">Staff Contact Num</label>
                                    <input type="text" class="form-control" id="staffContactNo" name="staffContactNo" placeholder="Write a Staff's Contact Num" required/>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-fullname">Staff Email</label>
                                    <input type="email" class="form-control" id="staffEmail" name="staffEmail" placeholder="Write a Staff's Email" required/>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">Staff Position</label>
                                    <input type="text" class="form-control" id="staffPosition" name="staffPosition" placeholder="Write a Staff's Position" required/>
                                </div>
