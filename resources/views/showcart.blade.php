...
-->
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @foreach($data as $index => $item)
                            <form action="{{ url('/orderconfirm', $item->id) }}" method="post">
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @isset($data2[$index])
                                    <a class="btn btn-danger remove-btn" href="{{ url('/remove', $data2[$index]->id) }}">Remove</a>
                                    @endisset
                                </td>
                            </tr>
    ...
    <div id="appear" style="display: none;">
        <section class="section d-flex justify-content-center" id="menu">
            <div class="col-lg-6 col-md-8 col-sm-10 mx-auto"> <!-- Adjusted width -->
                <div class="contact-form p-4 shadow rounded bg-light"> <!-- Added padding, shadow, rounded corners, and background -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <select class="form-select" id="type" name="servicetype">
